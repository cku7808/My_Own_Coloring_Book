...
class LDC(nn.Module):
    ...
    def __init__(self):
        ...
        self.dblock_6 = _DenseBlock(3, 32, 96)
        ...
        # self.side_4 = SingleConvBlock(96, 16, 1)
        self.side_4 = SingleConvBlock(96, 32, 1)
        self.side_5 = SingleConvBlock(32, 256, 1)
        # self.side_5 = SingleConvBlock(128, 256, 1)
        ...
        # self.pre_dense_5 = SingleConvBlock(96, 128, 1)
        self.pre_dense_6 = SingleConvBlock(32, 96, 1)
        # self.pre_dense_6 = SingleConvBlock(128, 256, 1)
        ...
        # self.up_block_5 = UpConvBlock(128, 3)
        self.up_block_6 = UpConvBlock(96, 3)
    ...
    def forward(self, x):
        ...
        # print("block_5",block_5.shape) # [8,32,44,44]
        # print("block_4_side",block_4_side.shape)
        block_5_add = block_5 + block_4_side
        block_5_side = self.side_5(block_5_add)

        # block 6
        block_6_pre_dense = self.pre_dense_6(block_5) # [8,32,44,44] block_5_pre_dense_512 +block_4_down
        block_6, _ = self.dblock_6([block_5_add, block_6_pre_dense]) # [8,32,44,44]
