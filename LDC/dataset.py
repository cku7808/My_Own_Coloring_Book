...
def dataset_info(dataset_name, is_linux=True):
    if is_linux:
        ...
        config = {
            ...
            'land_train': {'img_height': 512,
                    'img_width': 512,
                    # 'test_list': "test_pair.lst",
                    'train_list': "train_pair.lst",
                    'data_dir': 'data/land_train',  # mean_rgb
                    'yita': 0.2},
            'land_test': {'img_height': 512,
                    'img_width': 512,
                    'test_list': "test_pair.lst",
                    'data_dir': 'data/land_test',  # mean_rgb
                    'yita': 0.2},
            'land_val': {'img_height': 512,
                    'img_width': 512,
                    'test_list': "val_pair.lst",
                    # 'train_list': "train_pair.lst",
                    'data_dir': 'data/land_val',  # mean_rgb
                    'yita': 0.2},

            'face_train': {'img_height': 512,
                    'img_width': 512,
                    # 'test_list': "test_pair.lst",
                    'train_list': "train_pair.lst",
                    'data_dir': 'data/face_train',  # mean_rgb
                    'yita': 0.2},
            'face_test': {'img_height': 512,
                    'img_width': 512,
                    'test_list': "test_pair.lst",
                    'data_dir': 'data/face_test',  # mean_rgb
                    'yita': 0.2},
            'face_val': {'img_height': 512,
                    'img_width': 512,
                    'test_list': "val_pair.lst",
                    # 'train_list': "train_pair.lst",
                    'data_dir': 'data/face_val',  # mean_rgb
                    'yita': 0.2},
        ...
        config = {
            ...
            'BIPED': {'img_height': 720,  # 720
                      ...
                      'test_list': 'test_rgb.lst',
                      'train_list': 'train_rgb.lst',
                      'data_dir': 'opt/dataset/BIPED',  # WIN: '../.../dataset/BIPED/edges'
                      'yita': 0.5},
            'BIPED-B2': {'img_height': 720,  # 720
                      'img_width': 1280,  # 1280
                      'test_list': 'test_pair.lst',
...
class TrainDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.data_index = self._build_index()
        print(f"train mean_bgr: {self.mean_bgr}")
    ...
    def _build_index(self):
        ...
        if self.arg.train_data.lower() == 'biped':
            ...
            print(file_path)
            # if self.arg.train_data.lower() == 'transfer':
            if self.arg.train_data.lower() in ['land_train','face_train']:
    ...
    def transform(self, img, gt):
        ...
        # for BSDS 352/BRIND
        if crop_size != None and i_w > crop_size and i_h > crop_size:  # later 400, before crop_size
